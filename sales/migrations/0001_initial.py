    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_email', models.EmailField(max_length=75, blank=True)),
                ...
                ('modified_date', models.DateTimeField(default=datetime.datetime(2015, 3, 13, 22, 28, 18, 857000, tzinfo=utc), blank=True)),
                ('lot_price', models.IntegerField(default=0, null=True)),
                ('client', models.ForeignKey(to='config.Client')),
